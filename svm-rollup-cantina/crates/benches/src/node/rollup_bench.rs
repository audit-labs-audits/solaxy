...
fn stf_apply_slot_bench(c: &mut Criterion) {
    ...
    let (demo_genesis_config, roles) =
        setup_with_genesis_and_roles(params.blocks, MockCodeCommitment::default());
    ...
    c.bench_function("SVM rollup main stf loop", |b| {
        b.iter(|| {
...
fn configure_criterion() -> Criterion {
    Criterion::default()
        ...
        .measurement_time(std::time::Duration::from_secs(145))
}
