...
impl RollupBlueprint<Native> for CelestiaSvmRollup<Native>
where
...
impl RollupBlueprint<WitnessGeneration> for CelestiaSvmRollup<WitnessGeneration>
where
...
#[async_trait]
impl FullNodeBlueprint<Native> for CelestiaSvmRollup<Native> {
...
impl WalletBlueprint<Native> for CelestiaSvmRollup<Native> {}
